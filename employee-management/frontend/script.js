...
async function loadProjects() {
    ...
    try {
        ...
        projects.forEach(project => {
            ...
            const checkbox =
                projectItem.querySelector(".project-checkbox");

            const statusSelect =
                projectItem.querySelector(".project-status");
        ...
        if (checkbox.checked) {
            ...
            const statusSelect =
                document.querySelector(
                    `.project-status[data-project-id="${projectId}"]`
                );
...
function updateDashboard() {
    ...
    document.getElementById("unassignedEmployees").textContent =
        unassignedEmployees;
}
...
function changeItemsPerPage() {
    ...
    itemsPerPage =
        Number(document.getElementById("itemsPerPage").value);
    ...
    async function (event) {
        ...
        try {
            ...
            if (employeeId) {
                ...
                employee.projects = getSelectedProjects();
